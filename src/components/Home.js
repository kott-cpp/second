...
const Home = () => {
  const notifyA = () => toast("This is on the Bottom-Left corner", {containerId: 'A'});
  const notifyB = () => toast("This is on the Top-Right corner", {containerId: 'B'});
  ...
  return (
    <div>
      ...
      <div>
        <ToastContainer enableMultiContainer containerId={'C'} position={toast.POSITION.BOTTOM_RIGHT} />
